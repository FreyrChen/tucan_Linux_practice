...
public class FingerprintWraper {
 ...
 //   public native String  unimplementedStringFromJNI();
	...
	public native byte[] fingerprint(short data[], int numSamples);
	 ...
	 */
	/*
	public byte[] generate(float data[], int numSamples)
	{
		Log.i("lib","info fingerprint()");
	...
	public byte[] generate(short data[], int numSamples)
	{
		...
		/*
		Log.i("lib","data is short, try to transform to float");
