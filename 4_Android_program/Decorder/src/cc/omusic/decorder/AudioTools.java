...
public class AudioTools {
	...
	*/
	...
	static public void toShort (byte[] src, int offsetSrc, short[] dst, int offsetDst, int numBytes) throws Exception {
		if (numBytes % 2 != 0) throw new Exception("bytes must be even (2 bytes 16-bit PCM expected)");
	...
	static public void toFloat (byte[] src, int offsetSrc, float[] dst, int offsetDst, int numBytes) throws Exception {
		if (numBytes % 2 != 0) throw new Exception("bytes must be even (2 bytes 16-bit PCM expected)");
