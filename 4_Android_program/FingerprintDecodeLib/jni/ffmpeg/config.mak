...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --sysroot=/home/tusion/android-ndk/android-ndk-r8e/platforms/android-14/arch-arm --soname-prefix=/data/data/cc.omusic.FingerprintDecodeApp/lib/ --enable-shared --disable-symver --enable-small --optimization-flags=-O2 --disable-everything --enable-cross-compile --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-avdevice --disable-avresample --disable-avfilter --disable-encoders --disable-muxers --disable-filters --disable-devices --disable-everything --disable-decoders --enable-decoder=mp2 --enable-decoder=mp3 --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=wmalossless --enable-decoder=wmapro --enable-decoder=wmav1 --enable-decoder=wmav2 --enable-decoder=wmavoice --disable-protocols --enable-protocol=file --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=mpegaudio --disable-demuxers --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=ogg --enable-demuxer=asf --enable-demuxer=xwma --enable-demuxer=flv --disable-bsfs --disable-network --disable-swscale --disable-demuxer=sbg --disable-demuxer=dts --disable-parser=dca --disable-decoder=dca --prefix=/home/tusion/code/4_Android_program/FingerprintDecodeLib/jni/ffmpeg/build/ffmpeg/armeabi-v7a --extra-cflags='-march=armv7-a -mfloat-abi=softfp' --extra-ldflags=
prefix=/home/tusion/code/4_Android_program/FingerprintDecodeLib/jni/ffmpeg/build/ffmpeg/armeabi-v7a
...
SONAME_PREFIX=/data/data/cc.omusic.FingerprintDecodeApp/lib/
SRC_PATH=.
...
CPPFLAGS= --sysroot=/home/tusion/android-ndk/android-ndk-r8e/platforms/android-14/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -march=armv7-a -mfloat-abi=softfp  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O2 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -march=armv7-a -mfloat-abi=softfp  -fPIC -g
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS=  --sysroot=/home/tusion/android-ndk/android-ndk-r8e/platforms/android-14/arch-arm -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
FFSERVERLDFLAGS=-Wl,-E
SHFLAGS=-shared -Wl,-soname,$$(SONAME_PREFIX)$$(@F) -Wl,-Bsymbolic -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
YASMFLAGS=
BUILDSUF=
PROGSSUF=
