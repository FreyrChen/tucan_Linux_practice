...
=item B<-print_format> I<writer_name>B<[=>I<writer_options>B<]>
...
separator character I<SEP> are escaped using C-like fashioned
...
C<compact=item_sep=,:nokey=1:escape=csv>.
