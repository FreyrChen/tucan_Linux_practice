...
=item B<-stats_in[:stream_specifier]> I<string> B<()>
...
F<img-002.jpeg>, ..., assuming an input frame rate of 10 frames per
second:
...
This filter accepts the syntax: I<ass_filename>[:I<options>],
where I<ass_filename> is the filename of the ASS file to read, and
I<options> is an optional sequence of I<key>=I<value> pairs,
separated by ":".
...
Scale the input video to I<width>:I<height>[:I<interl>={1|-1}] and/or convert the image format.
...
The C<setdar> and C<setsar> filters accept a parameter string
...
I<num>:I<den>, where I<num> and I<den> are the numerator
...
It accepts the following parameters:
I<width>:I<height>:I<pix_fmt_string>:I<timebase_num>:I<timebase_den>:I<sample_aspect_ratio_num>:I<sample_aspect_ratio.den>:I<scale_params>

All the parameters but I<scale_params> need to be explicitly
defined.
...
=item B<sample_aspect_ratio.num, sample_aspect_ratio.den>
...
=head2 nullsrc, rgbtestsrc, testsrc
