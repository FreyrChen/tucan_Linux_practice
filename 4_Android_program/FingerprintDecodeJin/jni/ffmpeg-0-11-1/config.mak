...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-static --disable-shared --enable-cross-compile --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-avdevice --disable-devices --enable-avfilter --disable-encoders --disable-muxers --disable-symver --disable-debug --disable-stripping --enable-gpl --enable-version3 --enable-nonfree --disable-doc --disable-everything --disable-decoders --enable-decoder=pcm_s16be --enable-decoder=pcm_s16le --enable-decoder=pcm_s16le_planar --enable-decoder=pcm_u16be --enable-decoder=pcm_u16le --enable-decoder=wavpack --enable-decoder=mp2 --enable-decoder=mp3 --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=wmapro --enable-decoder=wmav1 --enable-decoder=wmav2 --enable-decoder=wmavoice --enable-decoder=vorbis --enable-decoder=libvorbis --disable-protocols --enable-protocol=file --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=mpegaudio --enable-parser=vorbis --enable-parser=ac3 --disable-demuxers --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=pcm_s16be --enable-demuxer=pcm_s16le --enable-demuxer=pcm_u16be --enable-demuxer=pcm_u16le --enable-demuxer=wav --enable-demuxer=flv --enable-demuxer=flac --enable-demuxer=ogg --enable-demuxer=flv --enable-demuxer=asf --disable-bsfs --disable-network --disable-yasm --disable-asm --prefix=/home/tusion/code/4_Android_program/FingerprintDecodeJin/jni/ffmpeg-0-11-1/ffmpeg --cc=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi- --nm=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-nm --extra-cflags='-fPIC -DANDROID -I/home/tusion/android-ndk/android-ndk-r8e/platforms/android-14/arch-arm/usr/include' --extra-ldflags='-L/home/tusion/android-ndk/android-ndk-r8e/platforms/android-14/arch-arm/usr/lib -nostdlib'
prefix=/home/tusion/code/4_Android_program/FingerprintDecodeJin/jni/ffmpeg-0-11-1/ffmpeg
...
ARCH=c
CC=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
CXX=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-g++
AS=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
LD=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCC=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-ar
RANLIB=/home/tusion/android-ndk/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=echo skipping strip
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -fPIC -DANDROID -I/home/tusion/android-ndk/android-ndk-r8e/platforms/android-14/arch-arm/usr/include  -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -fPIC -DANDROID -I/home/tusion/android-ndk/android-ndk-r8e/platforms/android-14/arch-arm/usr/include  -fPIC
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -L/home/tusion/android-ndk/android-ndk-r8e/platforms/android-14/arch-arm/usr/lib -nostdlib -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
ACODEC_TESTS=adpcm_adx aref dca g723_1 pcm_alaw pcm_f32be pcm_f32le pcm_f64be pcm_f64le pcm_mulaw pcm_s16be pcm_s16le pcm_s24be pcm_s24le pcm_s32be pcm_s32le pcm_s8 pcm_u8 ra144 roqaudio 
VCODEC_TESTS=amv avui cljr dnxhd_720p_10bit ffvhuff jpeg2000 msvideo1 prores prores_kostya qtrle qtrlegray r210 v210 v308 v408 vref y41p yuv4 
LAVF_FATE_TESTS=latm mp3 
LAVF_TESTS=caf dpx pam rso sox sunrast voc_s16 wtv xbm xwd 
LAVFI_TESTS=crop crop_scale crop_scale_vflip crop_vflip drawbox fade life null overlay pad pixdesc pixfmts_copy pixfmts_crop pixfmts_hflip pixfmts_null pixfmts_pad pixfmts_scale pixfmts_vflip scale200 scale500 select setdar setsar testsrc thumbnail transpose unsharp vflip vflip_crop vflip_vflip 
SEEK_TESTS=seek_ac3_ac3 seek_adpcm_ima_wav seek_adpcm_ms_wav seek_adpcm_qt_aiff seek_adpcm_swf_flv seek_adpcm_yam_wav seek_alac_m4a seek_asv1_avi seek_asv2_avi seek_dnxhd_1080i_mov seek_dnxhd_720p_dnxhd seek_dnxhd_720p_rd_dnxhd seek_dv411_dv seek_dv50_dv seek_dv_dv seek_error_mpeg4_adv_avi seek_ffv1_avi seek_flac_flac seek_flashsv_flv seek_flv_flv seek_h261_avi seek_h263_avi seek_h263p_avi seek_huffyuv_avi seek_image_bmp seek_image_jpg seek_image_pcx seek_image_pgm seek_image_ppm seek_image_sgi seek_image_tga seek_image_tiff seek_jpegls_avi seek_lavf_aif seek_lavf_al seek_lavf_asf seek_lavf_au seek_lavf_avi seek_lavf_dv seek_lavf_ffm seek_lavf_flv seek_lavf_gif seek_lavf_gxf seek_lavf_mkv seek_lavf_mmf seek_lavf_mov seek_lavf_mpg seek_lavf_mxf seek_lavf_nut seek_lavf_ogg seek_lavf_rm seek_lavf_swf seek_lavf_ts seek_lavf_ul seek_lavf_voc seek_lavf_wav seek_lavf_wtv seek_lavf_y4m seek_ljpeg_avi seek_mjpeg_avi seek_mp2_mp2 seek_mpeg1_mpg seek_mpeg1b_mpg seek_mpeg2_422_mpg seek_mpeg2_idct_int_mpg seek_mpeg2i_mpg seek_mpeg2ivlc_qprd_mpg seek_mpeg2thread_mpg seek_mpeg2threadivlc_mpg seek_mpeg4_adap_avi seek_mpeg4_adv_avi seek_mpeg4_nr_avi seek_mpeg4_qprd_avi seek_mpeg4_rc_avi seek_mpeg4_thread_avi seek_msmpeg4_avi seek_msmpeg4v2_avi seek_odivx_mp4 seek_pbmpipe_pbm seek_pcm_alaw_wav seek_pcm_f32be_au seek_pcm_f32le_wav seek_pcm_f64be_au seek_pcm_f64le_wav seek_pcm_mulaw_wav seek_pcm_s16be_mov seek_pcm_s16le_wav seek_pcm_s24be_mov seek_pcm_s24le_wav seek_pcm_s32be_mov seek_pcm_s32le_wav seek_pcm_s8_mov seek_pcm_u8_wav seek_pgmpipe_pgm seek_ppmpipe_ppm seek_rgb_avi seek_roqav_roq seek_rv10_rm seek_rv20_rm seek_snow53_avi seek_snow_avi seek_svq1_mov seek_wmv1_avi seek_wmv2_avi seek_yuv_avi 
